...
for p in bit_flip_p:
    ...
    rectify_decoder = MavlinkRectifyingDecoder(DecoderWiFi(spec=WiFiSpecCode.N1944_R23, max_iter=ldpc_iterations),
                                               seg_iter, ldpc_iterations, encoder.k, bad_p=bad_p, good_p=good_p)
